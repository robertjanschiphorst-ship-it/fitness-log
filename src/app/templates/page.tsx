      ...
      <div className="mx-auto max-w-2xl space-y-6">
        ...
        <header className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-[var(--text-40)] uppercase tracking-wider">{templates.length} template{templates.length !== 1 ? "s" : ""}</p>
          </div>
          <Link
        ...
        {templates.length === 0 ? (
          <div className="rounded-xl border border-[var(--border)] p-10 text-center">
            <p className="text-[var(--text-40)]">No templates yet.</p>
          ...
          <ul className="space-y-2">
            {templates.map((t) => (
              <li key={t.id} className="group rounded-xl border border-[var(--border)] bg-[var(--card)] hover:border-orange-500/30 transition-all">
                <div className="flex items-center gap-4 p-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-[var(--text-40)] mt-0.5 uppercase tracking-wide">
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    <Link
                      href={`/templates/${t.id}`}
                      className="rounded-lg bg-[var(--input-bg)] px-3 py-1.5 text-xs font-medium hover:bg-orange-500/20 hover:text-orange-400 transition-all"
                    >
                      Open →
                    </Link>
                  </div>
